      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-slate-900 leading-tight">
            سياسة الخصوصية لـ <span className="text-gradient">سلّابوت</span>
          </h1>
        ...
        >
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              نهتم في منصة <b>سلّابوت</b> (المساعد الذكي لمتاجر سلة) بخصوصية بياناتك وبيانات عملائك بشكل قصوى. توضح هذه السياسة كيف نجمع، ونعالج، ونحمي المعلومات والبيانات عند استخدامك لمنصتنا وتكاملها مع متجرك الإلكتروني. باستخدامك لسلّابوت، فإنك توافق على الممارسات الموضحة في هذه الصفحة.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <ul className="list-disc list-inside space-y-2.5 text-slate-600 text-sm sm:text-base mr-2">
              ...
              <li><b>بيانات الحساب:</b> البريد الإلكتروني للمدير، واسم المستخدم، وتفاصيل الدخول الخاصة بلوحة تحكم سلّابوت لتوثيق الحساب.</li>
            </ul>
          </div>
