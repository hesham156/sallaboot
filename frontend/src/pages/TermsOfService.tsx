      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-slate-900 leading-tight">
            شروط الخدمة لـ <span className="text-gradient">سلّابوت</span>
          </h1>
        ...
        >
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              باستخدامك أو تسجيلك في منصة <b>سلّابوت</b>، فإنك تقر وتوافق على الالتزام بشروط الخدمة هذه. إذا كنت لا توافق على هذه الشروط كلياً أو جزئياً، فيجب عليك عدم استخدام المنصة أو أي من خدماتها المتاحة.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              سلّابوت هي منصة برمجيات كخدمة (SaaS) تقدم حلول الذكاء الاصطناعي لمتاجر سلة، بما في ذلك روبوتات محادثة تفاعلية للرد الفوري على أسئلة العملاء، وتوفير حاسبات تسعير متقدمة للمنتجات المخصصة، واستعادة السلات المتروكة وتأكيد الطلبات تلقائياً. يحق لنا تعديل، تحديث، أو إيقاف أي جزء من الخدمة في أي وقت لغرض التطوير أو الصيانة.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <ul className="list-disc list-inside space-y-2.5 text-slate-600 text-sm sm:text-base mr-2">
              ...
              <li>أنت تفوض سلّابوت بشكل كامل للاتصال بمتجرك عبر واجهة برمجة التطبيقات (API) الخاصة بسلة لقراءة المنتجات، وتحديث الأسعار، وتلقي تنبيهات الطلبات لضمان عمل الخدمة بشكل صحيح.</li>
            </ul>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-3">
              أنت توافق على استخدام سلّابوت بطريقة تتوافق مع الأنظمة والقوانين المعمول بها. يمنع منعاً باتاً استخدام المنصة في:
            </p>
            <ul className="list-disc list-inside space-y-2.5 text-slate-600 text-sm sm:text-base mr-2">
              ...
              <li>محاولة فك تشفير، أو اختراق، أو إلحاق الضرر بالبنية التحتية البرمجية لسلّابوت.</li>
            </ul>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              إلى أقصى حد يسمح به القانون المعمول به، لا يتحمل سلّابوت بأي حال من الأحوال المسؤولية عن أي خسائر مالية، أو خسارة في الأرباح، أو توقف للمتجر، أو أضرار ناتجة عن انقطاع مؤقت في الخدمة، أو مشاكل في الاتصال بخوادم سلة، أو فقدان للبيانات نتيجة لاستخدامك للمنصة.
            </p>
          </div>
