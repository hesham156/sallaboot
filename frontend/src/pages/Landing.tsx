...
const PARTNER_LOGOS = [
  { domain: 'salla.sa',         name: 'سلة' },
  { domain: 'zid.sa',           name: 'زد' },
  { domain: 'shopify.com',      name: 'Shopify' },
  { domain: 'noon.com',         name: 'نون' },
  { domain: 'stc.com.sa',       name: 'STC' },
  { domain: 'almarai.com',      name: 'المراعي' },
  { domain: 'jarir.com',        name: 'جرير' },
  { domain: 'extra.com',        name: 'اكسترا' },
  { domain: 'tabby.ai',         name: 'تابي' },
  { domain: 'tamara.co',        name: 'تمارا' },
  { domain: 'mrsool.co',        name: 'مرسول' },
  { domain: 'moyasar.com',      name: 'ميسر' },
]
      ...
      <footer className="border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm font-semibold text-slate-500">
            <a href="#features" className="hover:text-teal-600 transition-colors">المميزات</a>
            <a href="#how" className="hover:text-teal-600 transition-colors">كيف يعمل</a>
            <a href="#faq" className="hover:text-teal-600 transition-colors">الأسئلة الشائعة</a>
            <button onClick={() => navigate('/blog')} className="hover:text-teal-600 transition-colors">المدونة</button>
