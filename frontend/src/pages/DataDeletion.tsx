        ...
        >
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)]">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              وفقاً لقوانين حماية البيانات العامة وسياسات المطورين (مثل سياسات Meta/Facebook)، يحق لأي مستخدم يتفاعل مع تطبيق <b>سلّابوت</b> طلب حذف بياناته الشخصية المخزنة لدينا. نوضح في هذه الصفحة الإرشادات اللازمة لأصحاب المتاجر وعملائهم لإتمام هذه العملية بكل سهولة.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)] relative overflow-hidden">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-4">
              إذا كنت تملك متجراً إلكترونياً مشتركاً في سلّابوت وترغب في إلغاء حسابك وحذف جميع بيانات متجرك نهائياً، يمكنك القيام بذلك عبر إحدى الطرق التالية:
            </p>
              ...
              <div className="flex gap-3 items-start bg-slate-50 p-4 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                    توجه إلى لوحة تحكم متجرك في سلة، ثم اذهب إلى "التطبيقات المثبتة"، وابحث عن تطبيق "سلّابوت" وقم بعملية إلغاء التثبيت (Uninstall). عند القيام بذلك، يرسل نظام سلة تنبيهاً فورياً (Webhook) لخوادمنا، ويقوم نظامنا تلقائياً بحذف جميع بيانات متجرك وقاعدة التدريب والمنتجات المسحوبة والرموز السرية نهائياً من قاعدة البيانات.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-7 sm:p-8 shadow-[0_4px_24px_rgba(15,23,42,0.02)] relative overflow-hidden">
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-4">
              إذا كنت عميلاً أو زائراً قمت بالتواصل مع المساعد الذكي (سلّابوت) في أحد المتاجر الإلكترونية وترغب في مسح سجل محادثاتك أو بيانات التواصل الخاصة بك المخزنة لدى البوت:
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-3 items-start bg-slate-50 p-4 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-xs sm:text-sm mt-1 leading-relaxed">
                    يحق لك مطالبة إدارة المتجر الذي اشتريت منه بحذف بياناتك. يمكن لمدير المتجر من خلال لوحة تحكم سلّابوت مسح سجل أي محادثة أو طلب خاص بزبائنهم بضغطة زر.
                  </p>
                </div>
              </div>
