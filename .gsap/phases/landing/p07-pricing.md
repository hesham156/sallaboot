...
- Page: landing
- Section: Pricing
- Recipe Direction: pricing-card emphasis + trust hierarchy
- Status: Planned

## Objective

Make the Pricing section feel intentional, modern, and aligned with the page hierarchy.
...
- [ ] Verify mobile downgrade behavior for Pricing.
- [ ] Update the Pricing status and notes in .gsap artifacts.
